...
export async function setupProviderWithPayments (provider: providers.JsonRpcProvider, paymentsManager: PaymentsManager, paidRPCMethods: string[], paymentAmount: string): Promise<void> {
